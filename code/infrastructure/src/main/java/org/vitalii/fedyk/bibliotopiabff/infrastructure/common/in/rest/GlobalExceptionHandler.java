...
public class GlobalExceptionHandler {
  ...
  public ErrorDto handleBookNotFoundException(
      final BookNotFoundException exception, final Locale locale) {
    return ErrorDto.builder()
        .title(
            this.messageSource.getMessage(
                BOOK_NOT_FOUND, new Object[] {exception.getIsbn()}, locale))
        .build();
  }
